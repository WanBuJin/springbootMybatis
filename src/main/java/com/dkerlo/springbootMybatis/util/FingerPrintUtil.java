package com.dkerlo.springbootMybatis.util;/*
 * @Author: Dkerlo
 * @Description :
 * @Date: 创建于 2018/4/28
 * @Modified By:Dkerlo
...
public final class FingerPrintUtil {
    ...
    public FingerPrintUtil(byte[] hashValue) {
    ...
    public FingerPrintUtil(String hashValue) {
        this(toBytes(hashValue));
    }

    public FingerPrintUtil(BufferedImage src) {
        this(hashValue(src));
    }
    ...
    /**
     * 从压缩格式指纹创建{@link FingerPrintUtil}对象
     *
     * @param compactValue
     * @return
     */
    public static FingerPrintUtil createFromCompact(byte[] compactValue) {
        return new FingerPrintUtil(uncompact(compactValue));
    }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof FingerPrintUtil) {
            return Arrays.equals(this.binaryzationMatrix, ((FingerPrintUtil) obj).binaryzationMatrix);
        } else
    ...
    public float compare(String hashValue) {
        return compare(new FingerPrintUtil(hashValue));
    }
    ...
    public float compare(BufferedImage image2) {
        return compare(new FingerPrintUtil(image2));
    }
     ...
     */
    public float compare(FingerPrintUtil src) {
    ...
    public static float compare(BufferedImage image1, BufferedImage image2) {
        return new FingerPrintUtil(image1).compare(new FingerPrintUtil(image2));
    }
    ...
    public static void main(String[] args) {
        ...
        try {
            FingerPrintUtil fp1 = new FingerPrintUtil(ImageIO.read(new File("d:\\001.png")));
            FingerPrintUtil fp2 =new FingerPrintUtil(ImageIO.read(new File("d:\\004.png")));
